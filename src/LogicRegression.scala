...
//    Logger.getLogger("org.eclipse.jetty.server").setLevel(Level.ERROR)
    ...
    val conf = new SparkConf().setAppName("垃圾邮件分类").setMaster("spark://spark-B470:7077")
    val sc = new SparkContext(conf)

    val spam = sc.textFile("file:///home/hadoop/words/logicRegression/spam.txt")
    val ham = sc.textFile("file:///home/hadoop/words/logicRegression/Dham.txt")
